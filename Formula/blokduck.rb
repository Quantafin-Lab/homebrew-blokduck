...
class Blokduck < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Quantafin-Lab/blokduck/releases/download/v0.11.5/bd_obfuscate-aarch64-apple-darwin-v0.11.5.tar.gz"
      sha256 "__ARM_SHA256__"
    else
      url "https://github.com/Quantafin-Lab/blokduck/releases/download/v0.11.5/bd_obfuscate-x86_64-apple-darwin-v0.11.5.tar.gz"
