...
class Blokduck < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Quantafin-Lab/blokduck/releases/download/v0.12.1/bd_obfuscate-aarch64-apple-darwin-v0.12.1.tar.gz"
      sha256 "__ARM_SHA256__"
    else
      url "https://github.com/Quantafin-Lab/blokduck/releases/download/v0.12.1/bd_obfuscate-x86_64-apple-darwin-v0.12.1.tar.gz"
